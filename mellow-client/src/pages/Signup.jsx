...
const Signup = () => {
    ...
    const handleSignUp = async (e) => {
        ...
        if (password !== password2) {
            toast.error("Password confirmation unsuccessful! Please correct to proceed");
            return;
        }
                ...
                <div className="py-12">
                    <div className="w-[80%] mx-auto rounded-2xl border p-8 sm:w-full">
                        <h3 className="text-2xl font-semibold text-gray-700 text-center">
                            <span className="text-yellow-500">Join Us</span> to Experience an Exciting Journey <br />
                            with <span className="text-2xl font-bold">Mell<span className="text-yellow-500 text-3xl font-normal">ow</span></span>
                        </h3>
                        ...
                        <form onSubmit={handleSignUp} className="mt-10 space-y-8">
                            ...
                            <div className="flex flex-col items-end w-full">
                                <div className="w-full flex relative before:absolute before:bottom-0 before:h-0.5 before:left-0 before:origin-right focus-within:before:origin-left before:right-0 before:scale-x-0 before:m-auto before:bg-yellow-400 focus-within:before:!scale-x-100 focus-within:invalid:before:bg-red-400 before:transition before:duration-500">
                                    <input type={showPass ? "text" : "password"} placeholder="Your password" name="password" className="w-full bg-transparent pb-3 border-b border-gray-500 outline-none invalid:border-red-400 transition" required />
                                    <span className="absolute right-4 top-1" onClick={() => { setShowPass(!showPass); setTimeout(() => setShowPass(false), 3000); }}>
                            ...
                            <div className="flex flex-col items-end w-full">
                                <div className="w-full flex relative before:absolute before:bottom-0 before:h-0.5 before:left-0 before:origin-right focus-within:before:origin-left before:right-0 before:scale-x-0 before:m-auto before:bg-yellow-400 focus-within:before:!scale-x-100 focus-within:invalid:before:bg-red-400 before:transition before:duration-500">
                                    <input type={showPass2 ? "text" : "password"} placeholder="Re-enter and confirm password" name="password2" className="w-full bg-transparent pb-3 border-b border-gray-500 outline-none invalid:border-red-400 transition" required />
                                    <span className="absolute right-4 top-1" onClick={() => { setShowPass2(!showPass2); setTimeout(() => setShowPass2(false), 3000); }}>
                            ...
                            <div>
                                <button type="submit" className="w-full rounded-full bg-yellow-400 h-11 flex items-center justify-center px-6 py-3 hover:bg-yellow-600 active:bg-yellow-700 transition-colors duration-500">
